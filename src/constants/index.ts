const bridgeDexSwapConfig = {
  mainnet: {
    ...
    ae_bridge_address:
      'ct_2Xdym95f2i998W9Zoh1NgAB7pVuQ34ztEsema7u4XwSoq5VKUJ' as `ct_${string}`,
    ae_wae_address:
      'ct_J3zBY8xxjsRr3QojETNw48Eb38fjvEuJKkQ6KzECvubvEcvCa' as `ct_${string}`,
    ae_dex_router_address:
      'ct_azbNZ1XrPjXfqBqbAh1ffLNTQ1sbnuUDFvJrXjYz7JQA1saQ3' as `ct_${string}`,
    ae_weth_address:
      'ct_ryTY1mxqjCjq1yBn9i6HDaCSdA6thXUFZTA84EMzbWd1SLKdh' as `ct_${string}`,
  ...
  testnet: {
    ...
    ae_bridge_address:
      'ct_2C5nHYyzUMiqU9HE32XNLN47pFEDL2bNpVTAsG5XmZNigvM4Fv' as `ct_${string}`,
    ae_wae_address:
      'ct_JDp175ruWd7mQggeHewSLS1PFXt9AzThCDaFedxon8mF8xTRF' as `ct_${string}`,
    ae_dex_router_address:
...
export const Constants = {
  ...
  ae_network_id:
    bridgeDexSwapConfig[isMainnet ? 'mainnet' : 'testnet'].ae_network_id,
  eth_mock_address:
    bridgeDexSwapConfig[isMainnet ? 'mainnet' : 'testnet'].eth_mock_address,
  eth_bridge_address:
    bridgeDexSwapConfig[isMainnet ? 'mainnet' : 'testnet'].eth_bridge_address,
  ae_bridge_address:
    bridgeDexSwapConfig[isMainnet ? 'mainnet' : 'testnet'].ae_bridge_address,
  ae_wae_address:
    bridgeDexSwapConfig[isMainnet ? 'mainnet' : 'testnet'].ae_wae_address,
  ae_dex_router_address:
    bridgeDexSwapConfig[isMainnet ? 'mainnet' : 'testnet']
      .ae_dex_router_address,
  ae_weth_address:
    bridgeDexSwapConfig[isMainnet ? 'mainnet' : 'testnet'].ae_weth_address,
  eth_native_eth_placeholder_address:
    bridgeDexSwapConfig[isMainnet ? 'mainnet' : 'testnet']
      .eth_native_eth_placeholder_address,
  ae_web_socket_url:
    bridgeDexSwapConfig[isMainnet ? 'mainnet' : 'testnet'].ae_web_socket_url,
  ae_node_url:
    bridgeDexSwapConfig[isMainnet ? 'mainnet' : 'testnet'].ae_node_url,
  ae_middleware_url:
    bridgeDexSwapConfig[isMainnet ? 'mainnet' : 'testnet'].ae_middleware_url,
};

export const ETH_MAINNET_WAE_ADDRESS =
  '0xAbaE76F98A84D1DC3E0af8ed68465631165d33B2';
          ...
          arguments: [
            {
              name: 'assets',
              type: {
                map: ['string', 'FungibleTokenFullInterface'],
              },
            },
            {
              name: 'native_ae',
          ...
          arguments: [
            {
              name: 'x#1',
              type: {
                tuple: ['string', 'FungibleTokenFullInterface'],
              },
            },
          ],
          ...
          arguments: [
            {
              name: 'x#1',
              type: {
                tuple: ['int', 'string', 'address', 'int', 'int'],
              },
            },
          ],
          name: 'bridge_in',
      ...
      state: {
        record: [
          ...
          },
          {
            name: 'in_actions',
            type: {
              map: ['int', 'Bridge.in_bridge_action'],
            },
          },
          {
            name: 'owner',
