...
const AE_TESTNET_WRAPPED_AE_ADDRESS =
...
const tokenContractSource = fs.readFileSync(
...
await bridgeContract.init(
  [], // assets
  {
    eth_addr: ETH_MAINNET_WAE_ADDRESS,
    underlying_token: AE_TESTNET_WRAPPED_AE_ADDRESS,
  }, // native_ae
  {
    eth_addr: ETH_MAINNET_WETH_ADDRESS,
    underlying_token: tokenContract.$options.address,
  }, // native_eth
);
